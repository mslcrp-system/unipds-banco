-- ============================================================
-- Fix upsert_contracts_from_raw: normalizar ID Contrato (.0)
--
-- Voomp exporta 'ID Contrato' como float: '122137.0' em vez de '122137'.
-- Os outros IDs (Produto, Venda, Oferta) vem limpos.
-- Solucao: regexp_replace para remover '.0' no final em ID Contrato.
-- ============================================================
...
BEGIN
    ...
    WITH raw_assinaturas AS (
        SELECT
            f.tenant_id,
            f.fonte_id,
            -- Normaliza ID Contrato: remove '.0' no final (bug export Voomp)
